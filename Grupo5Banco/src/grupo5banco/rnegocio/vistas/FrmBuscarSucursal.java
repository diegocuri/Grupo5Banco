...
public class FrmBuscarSucursal extends javax.swing.JInternalFrame {
  ...
  ISucursal sucursalDao = new SucursalImpl();
        try {
            limpiarControles();
            sucursal = sucursalDao.obtener(
                    Integer.parseInt(txtBuscarCodigo.getText()));
            if (sucursal != null) {
                txtCodigo.setText(Integer.toString(sucursal.getCodSu()));
                txtNombre.setText(sucursal.getCiudad());
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error al buscar al Buscar Sucursal!!",
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
       ...
       int confirmation = JOptionPane.showConfirmDialog(this, 
               "Desea Eliminar la Sucursal", "Confirme",
               JOptionPane.YES_NO_OPTION);
       if(confirmation == JOptionPane.YES_NO_OPTION)
        try {
            if(sucursalDao.eliminar(sucursal)>0){
                JOptionPane.showMessageDialog(this, "Sucursal eliminado correctamente!!",
                        "Transaccion Correcta", JOptionPane.INFORMATION_MESSAGE);
                limpiarControles();
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error al eliminar Sucursal",
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
