...
import grupo5banco.rnegocio.impl.InspectorImpl;
 ...
 */
public class FrmBuscarInspector extends javax.swing.JInternalFrame {

    /**
     * Creates new form BuscarInspector
     */
    public FrmBuscarInspector() {
        initComponents();
  ...
  IInspector inspectorDao = new InspectorImpl();
        try {
            ...
            if (inspector != null) {
                txtCodigo.setText(Integer.toString(inspector.getCodIs()));
                txtNombre.setText(inspector.getNombre());
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error al buscar al Buscar Inspector!!",
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
       ...
       int confirmation = JOptionPane.showConfirmDialog(this, 
               "Desea Eliminar la Inspector", "Confirme",
       ...
       if(confirmation == JOptionPane.YES_NO_OPTION)
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al eliminar Inspector",
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
